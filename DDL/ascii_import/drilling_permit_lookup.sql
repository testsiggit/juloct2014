...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 28, 2014 at 07:02 PM
...
INSERT INTO `dp_wellbore_profile` (`wp_code`, `wp_name`) VALUES
('DR', 'Directional'),
('DS', 'Directional Sidetrack'),
('HR', 'Horizontal'),
('HS', 'Horizontal Sidetrack'),
('VR', 'Vertical'),
('VS', 'Vertical Sidetrack');
